  ...
  switch (code)
  {
    ...
    case CODE_LOAD_MODULE_VAR:
    {
      ...
      printf("%-16s %5d '%s'\n", "LOAD_MODULE_VAR", slot,
             fn->module->variableNames.data.data[slot]->value);
      break;
    }
    ...
    case CODE_ADD: printf("ADD\n"); break;
    case CODE_SUB: printf("SUB\n"); break;
    case CODE_MUL: printf("MUL\n"); break;
    case CODE_DIV: printf("DIV\n"); break;
    case CODE_LT:  printf("LT\n"); break;
    case CODE_GT:  printf("GT\n"); break;
    case CODE_LTE: printf("LTE\n"); break;
    case CODE_GTE: printf("GTE\n"); break;
    ...
    case CODE_CALL_16:
    {
      ...
      printf("CALL_%-11d %5d '%s'\n", numArgs, symbol,
             vm->methodNames.data.data[symbol]->value);
      break;
    }
    ...
    case CODE_SUPER_16:
    {
      ...
      printf("SUPER_%-10d %5d '%s' %5d\n", numArgs, symbol,
             vm->methodNames.data.data[symbol]->value, superclass);
      break;
    }
